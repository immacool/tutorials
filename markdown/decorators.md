...
1. [Что такое декоратор?](#что-такое-декоратор)
2. [Декораторы с аргументами](#декораторы-с-аргументами)
3. [Декораторы классов и методов](#декораторы-классов-и-методов)
4. [Декораторы функций в виде классов](#декораторы-функций-в-виде-классов)
5. [Ссылки](#ссылки)
6. [Сноски](#сноски)
...
* [Декораторы в Python](https://python-scripts.com/decorators) (python-scripts.com)
* [Оффициальная документация](https://docs.python.org/3.7/glossary.html#term-decorator) (docs.python.org)
* [Декорирование в Python](https://pythonworld.ru/osnovy/dekoratory.html) (pythonworld.ru)
